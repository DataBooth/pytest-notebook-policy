# Source: https://raw.githubusercontent.com/marimo-team/gallery-examples/main/notebooks/geo/earthquake.py
import marimo
...
@app.cell
def _(data):
    vector = ol.VectorLayer(source=ol.VectorSource(url=data))
    return (vector,)
